...
const API_BASE = `${process.env.NEXT_PUBLIC_API_HOST}:${process.env.NEXT_PUBLIC_API_PORT}/api/v1`;
...
export const restaurantApi = {
  ...
  updateRestaurant: async (
    id: number,
    data: { name?: string; slug?: string; file?: any; userId?: number }
  ) => {
...
export const orderTypeApi = {
  getOrderTypes: async (
    params: Partial<PaginationParams & { restaurantId: number }> = {}
  ) => {
